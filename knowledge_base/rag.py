...
```
[Краткий ответ на вопрос, 2-4 предложения]

📹 Источник: {название урока}
```

Правила:
1. Отвечай кратко и по существу
2. ОБЯЗАТЕЛЬНО добавь пустую строку перед "📹 Источник"
...
💡 <b>Важно:</b>
[Ключевой совет или пример]

📹 Источники: {названия уроков}
```

Правила:
1. Используй буллеты (•) для списков
2. Используй <b>жирный</b> для заголовков
3. Добавляй пустые строки между блоками
4. В конце ОБЯЗАТЕЛЬНО укажи источники
