...
5. 🎓 Обучение — AI-ассистент для вопросов по обучающим материалам (KPI, планирование, мотивация и др.)
...
Если вопрос касается обучения, KPI, показателей, планирования, мотивации — направь в «🎓 Обучение».
...
def get_fallback_suggestion(user_message: str) -> str:
    ...
    for section, words in keywords.items():
        if any(word in message_lower for word in words):
            if section == "tasks":
                ...
                return "💡 Для вопросов по обучению нажмите «🎓 Обучение» — там AI-ассистент ответит на ваши вопросы."
    ...
    return (
        ...
        "• 👤 Аккаунт — ваш профиль\n"
        "• 🎓 Обучение — вопросы по материалам"
    )
