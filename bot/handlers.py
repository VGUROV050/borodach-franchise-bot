...
async def cmd_start(message: types.Message, state: FSMContext) -> None:
    ...
    if partner is None:
        ...
        await message.answer(
            ...
            "Здесь вы сможете:\n"
            "📋 Ставить задачи в управляющую компанию\n"
            "📊 Смотреть статистику и рейтинг в сети\n"
    ...
    await message.answer(
        ...
        "📋 <b>Задачи</b> — создание и отслеживание\n"
        "📊 <b>Статистика</b> — выручка, рейтинг в сети\n"
        "🤖 <b>AI-ассистент</b> — ответы из базы знаний\n"
        "📚 <b>Полезное</b> — информация по отделам\n"
        "👤 <b>Аккаунт</b> — профиль и барбершопы\n"
        "📞 <b>Связаться</b> — контакты офиса\n\n"
        "Выберите раздел 👇",
        reply_markup=main_menu_keyboard(),
    )
...
async def ai_assistant_start(message: types.Message, state: FSMContext) -> None:
    ...
    await message.answer(
        "🤖 <b>AI-ассистент</b>\n\n"
        "Задавайте вопросы по обучающим материалам:\n\n"
        "📊 <b>KPI и показатели</b> — BSI, средний чек, загрузка\n"
        "📈 <b>Планирование</b> — год, месяц, цели\n"
        "👥 <b>Персонал</b> — мотивация, адаптация, контроль\n"
        "🎯 <b>Клиенты</b> — возврат КБ, сервис, гостеприимство\n"
        "📢 <b>Маркетинг</b> — геосервисы, SMM, реклама\n\n"
        "💬 <b>Просто напишите ваш вопрос!</b>\n\n"
        "<i>Например: «Как рассчитать коэффициент загрузки?»</i>",
